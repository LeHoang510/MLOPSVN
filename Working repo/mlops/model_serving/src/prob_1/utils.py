...
class AppPath:
    ...
    BATCH_INPUT_PQ = PROBLEM_1 / "batch_input.parquet"
    BATCH_OUTPUT_PQ = PROBLEM_1 / "batch_output.parquet"
...
class Config:
    def __init__(self) -> None:
        ...
        self.registered_model_1_file = os.environ.get("REGISTERED_MODEL_1_FILE")
