...
class AppPath:
    ...
    PROBLEM_2 = PHASE_1 / "prob_2"

    TRAINING_PQ_2 = PROBLEM_2 / "training.parquet"
    TRAIN_X_PQ_2 = PROBLEM_2 / "train_x.parquet"
    TRAIN_Y_PQ_2 = PROBLEM_2 / "train_y.parquet"
    TEST_X_PQ_2 = PROBLEM_2 / "test_x.parquet"
    TEST_Y_PQ_2 = PROBLEM_2 / "test_y.parquet"

    RUN_INFO = PROBLEM_2 / "run_info.json"
    EVALUATION_RESULT = PROBLEM_2 / "evaluation.json"

    REGISTERED_MODEL_2_VERSION = PROBLEM_2 / "registered_model_2_version.json"
...
class Config:
    def __init__(self) -> None:
        ...
        self.target_col = os.environ.get("MODEL_2_TARGET_COL")
        self.test_size = float(os.environ.get("MODEL_2_TEST_SIZE"))
        self.experiment_name = os.environ.get("MODEL_2_EXPERIMENT_NAME")
        self.mlflow_tracking_uri = os.environ.get("MLFLOW_TRACKING_URI")
        self.alpha = float(os.environ.get("MODEL_2_ALPHA"))
        self.l1_ratio = float(os.environ.get("MODEL_2_L1_RATIO"))
        self.rmse_threshold = float(os.environ.get("MODEL_2_RMSE_THRESHOLD"))
        self.mae_threshold = float(os.environ.get("MODEL_2_MAE_THRESHOLD"))

        self.registered_model_2_name = os.environ.get("REGISTERED_MODEL_2_NAME")
